...
CATALOG: List[Dict[str, Any]] = [
    ...
    {"product_id": "kaldewei-ka-120-horizontal", "product_name": "KALDEWEI KA 120 horizontal", "product_url": SEEDS["conoflat"], "family": "ka_120", "candidate_type": "component", "product_category": "tray_waste_fitting", "system_role": "tray_waste_fitting", "complete_system": "component", "model_number": "4106", "article_number": "687675", "outlet_orientation": "horizontal", "outlet_dn": "DN50", "dn": "DN50", "flow_rate_lps": 0.85, "water_seal_mm": 50, "height_adj_min_mm": 82, "height_adj_max_mm": 82, "current_status": "current", "compatibility_caution": "superplan_plus_unclear"},
    {"product_id": "kaldewei-ka-120-flat", "product_name": "KALDEWEI KA 120 flat", "product_url": SEEDS["conoflat"], "family": "ka_120", "candidate_type": "component", "product_category": "tray_waste_fitting", "system_role": "tray_waste_fitting", "complete_system": "component", "model_number": "4107", "article_number": "687676", "outlet_orientation": "flat", "outlet_dn": "DN40", "dn": "DN40", "flow_rate_lps": 0.85, "water_seal_mm": 30, "height_adj_min_mm": 65, "height_adj_max_mm": 65, "current_status": "current", "compatibility_caution": "superplan_plus_unclear"},
    {"product_id": "kaldewei-ka-120-vertical", "product_name": "KALDEWEI KA 120 vertical", "product_url": SEEDS["conoflat"], "family": "ka_120", "candidate_type": "component", "product_category": "tray_waste_fitting", "system_role": "tray_waste_fitting", "complete_system": "component", "model_number": "4108", "article_number": "687677", "outlet_orientation": "vertical", "outlet_dn": "DN50", "dn": "DN50", "flow_rate_lps": 1.4, "water_seal_mm": 50, "height_adj_min_mm": 95, "height_adj_max_mm": 95, "current_status": "current", "compatibility_caution": "superplan_plus_unclear"},
...
def extract_parameters(url: str) -> Dict[str, Any]:
    ...
    if frag:
        ...
        if row:
            return {k: v for k, v in row.items() if k in {"flow_rate_lps", "outlet_dn", "dn", "outlet_orientation", "height_adj_min_mm", "height_adj_max_mm", "water_seal_mm", "current_status", "compatibility_caution", "finish_name", "finish_code", "model_number", "article_number", "product_category", "system_role", "complete_system"}}
    for r in CATALOG:
