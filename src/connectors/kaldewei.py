...
CATALOG: List[Dict[str, Any]] = [
    ...
    {"product_id": "kaldewei-ka-90-horizontal", "product_name": "KALDEWEI KA 90 horizontal", "product_url": SEEDS["waste"], "family": "ka_90", "candidate_type": "component", "product_category": "tray_waste_fitting", "system_role": "tray_waste_fitting", "complete_system": "component", "benchmark_eligible": False, "model_number": "4103", "outlet_orientation": "horizontal", "outlet_dn": "DN50", "dn": "DN50", "flow_rate_lps": 0.71},
    {"product_id": "kaldewei-ka-90-flat", "product_name": "KALDEWEI KA 90 flat", "product_url": SEEDS["waste"], "family": "ka_90", "candidate_type": "component", "product_category": "tray_waste_fitting", "system_role": "tray_waste_fitting", "complete_system": "component", "benchmark_eligible": False, "model_number": "4104", "outlet_orientation": "flat", "outlet_dn": "DN40", "dn": "DN40", "flow_rate_lps": 0.68},
    {"product_id": "kaldewei-ka-90-vertical", "product_name": "KALDEWEI KA 90 vertical", "product_url": SEEDS["waste"], "family": "ka_90", "candidate_type": "component", "product_category": "tray_waste_fitting", "system_role": "tray_waste_fitting", "complete_system": "component", "benchmark_eligible": False, "model_number": "4105", "outlet_orientation": "vertical", "outlet_dn": "DN50", "dn": "DN50", "flow_rate_lps": 1.22},
...
def extract_parameters(url: str) -> Dict[str, Any]:
    ...
    if frag:
        ...
        if row:
            return {k: v for k, v in row.items() if k in {"flow_rate_lps", "outlet_dn", "dn", "outlet_orientation", "height_adj_min_mm", "height_adj_max_mm", "construction_height_mm", "water_seal_mm", "current_status", "compatibility_caution", "finish_name", "finish_code", "model_number", "article_number", "product_category", "system_role", "complete_system"}}
    for r in CATALOG:
