...
def test_summarize_final_assemblies_groups_and_missing_fields():
    products = pd.DataFrame([
        {"product_id": "aco-assembled-showerdrain-splus-a__g1", "flow_rate_lps": 1.0, "water_seal_mm": 30, "outlet_dn": "DN50", "height_adj_min_mm": 10, "height_adj_max_mm": 20},
        {"product_id": "aco-assembled-showerdrain-c-a__g1", "flow_rate_lps": "", "water_seal_mm": 30, "outlet_dn": "DN50", "height_adj_min_mm": 10, "height_adj_max_mm": 20},
    ...
    assert summary["missing_by_id"] == {
        "aco-assembled-showerdrain-c-a__g1": ["flow_rate_lps"]
    }


def test_main_prints_blocked_families(monkeypatch, capsys):
    products = pd.DataFrame([
        {"product_id": "aco-assembled-showerdrain-splus-a__g1", "product_family": "showerdrain_splus", "flow_rate_lps": 1.0, "water_seal_mm": 30, "outlet_dn": "DN50", "height_adj_min_mm": 10, "height_adj_max_mm": 20},
    ])
