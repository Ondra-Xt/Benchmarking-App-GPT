...
def test_exported_inventory_csv_prefers_structured_tecedrainline_rows(tmp_path):
    ...
    (pack / "line_tables.txt").write_text(
        ...
        '800 mm Edelstahl gebürstet 600800 1 St. 900 mm Edelstahl gebürstet 600900 1 St. 1000 mm Edelstahl gebürstet 601000 1 St. '
        '1200 mm Edelstahl gebürstet 601200 1 St. 1500 mm Edelstahl gebürstet 601500 1 St. '
