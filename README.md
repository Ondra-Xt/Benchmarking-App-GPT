...
TECE MVP konektor je postavený na `productdaten.tece.de` (seed PR produktové stránky) a na oficiální stránce `tece.com/de` pro odtoky (`Abläufe und Zubehör`) pro průtokové hodnoty.
